...
def eat_ghost(power_pellet_active, touching_ghost):
    ...
    if power_pellet_active == True and touching_ghost == True:
        ...
        return False
resultado = eat_ghost(True, False)
#print(resultado)
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    """
    loses = lose(power_pellet_active, touching_ghost)
    if loses:
        return False
        ...
        return False
resultado3 = win(False, True, False)
#print(resultado3)
