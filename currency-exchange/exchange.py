...
def get_value_of_bills(denomination, number_of_bills):
    ...
    valueofbills = denomination * number_of_bills
    return valueofbills
...
def get_number_of_bills(amount, denomination):
    ...
    """
    numberofbills = int(amount / denomination)
...
def get_leftover_of_bills(amount, denomination):
    ...
    """
    leftoverofbills = amount % denomination
    return leftoverofbills
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    rspread = (exchange_rate / 100) * spread
    exchangeplus = exchange_rate + rspread

    total = budget / exchangeplus

    result = int(total - (total % denomination))
